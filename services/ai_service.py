...
def run_image_inspection(db: Session, file_path: str, filename: str, metadata: dict, active_model="yolo") -> dict:
    ...
    return {
        ...
        "heatmap_url": f"http://localhost:8000{db_inspection.heatmap_url}" if db_inspection.heatmap_url else None,
        "image_url": f"http://localhost:8000/static/uploads/{db_inspection.filename}",
